...
const navsBar = [
    ...
    { path: RoutePaths.team, name: 'About us' },
];
        ...
        <div className="header bg-white shadow sticky-top">
            <div className="d-lg-flex justify-content-between font-light fd-bg-secondary px-3 py-2 px-lg-5">
                ...
                <span>
                    ...
                    <a href="https://github.com/Sweta-singh-123" target="_blank" rel="noopener noreferrer">Sweta</a>
                </span>
                    <span><i className="bi bi-geo-alt fd-color-primary"></i>&nbsp;Lpu Jalandhar</span>
                </div>
